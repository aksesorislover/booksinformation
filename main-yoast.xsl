<?xml version="1.0" encoding="UTF-8"?>	<xsl:stylesheet version="2.0"
	...
	<xsl:template match="/">
		...
		<script type="text/javascript" src="http://yoast.com/wp-includes/js/jquery/jquery.js"></script>
		<script type="text/javascript" src="http://yoast.com/wp-content/plugins/wordpress-seo-premium/js/dist/jquery.tablesorter.min.js"></script>
